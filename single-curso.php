...
<div class="ui vertical basic segment cd-margem">
  ...
  <div class="ui grid container stackable">
    ...
    <div class="ten wide column">
      ...
      <?php endif; ?>
      <div class="ui hidden divider"></div>
      <a href="<?php bloginfo('url') ?>/solicitacao/?modalidade=<?php echo $modalidade['value']; ?>&titulo_curso=<?php the_title() ?>&area=<?php echo $area['value']; ?>&link_curso=<?php echo $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" class="ui right labeled icon button">
