...
<?php if ( !empty( $comments ) ) : ?>
  ...
  <?php foreach ( $comments as $comment ) : ?>
    ...
    <p>
      <?php echo $comment->comment_author . ' <em>disse</em>:<br>' . $comment->comment_content . '<br>' . $comment->comment_date ; ?><br>
      <?php comment_date('Y-m-d'); ?><br>
      <a href="<?php the_permalink($comment->comment_post_ID); ?>"><?= get_the_title($comment->comment_post_ID);  ?></a><br>
      <?php the_field('finalidade', $comment->comment_post_ID); ?>
    </p>
